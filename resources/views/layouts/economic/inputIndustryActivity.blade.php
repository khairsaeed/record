              ...
              <div class="card-header">
                <h4 class="card-title w-100">
                  <a class="d-block w-100 collapsed" data-toggle="collapse" href="#collapseOne" aria-expanded="false">
                    معلومات السجل ذو الرقم:   {{  Session::get('record')->record_nb }}
                  </a>
                </h4>
              </div>
              <div id="collapseOne" >
                <div class="card-body">
                    ...
                    <form action="{{ route('activity.store') }}" method="post" dir="rtl">
                        @include('layouts.economic.formIndustryActivity')


          <br>
                        <div class="row col-sm-12" class="" >
