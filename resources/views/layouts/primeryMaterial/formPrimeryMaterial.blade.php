...
<input type="text" value="{{ session()->get('product') }}" name="productId" class="form-control" style="background-color:#e6e6e6" hidden>

<div class="col-sm-6 nopadding" style="float: right;" >
<label for="hs_name" style="float: right;"><strong dir="rtl">الاسم السلعي</strong></label>
<input type="text" value="{{ $primeryMaterial->hs_name }}" name="hs_name" class="form-control" style="background-color:#e6e6e6" >
</div>
<div class="col-sm-6 nopadding">
<label for="describe" style="float: right;"><strong>الوصف</strong></label>
<input type="text" value="{{ old('describe')??  $primeryMaterial->describe }}" name="describe" class="form-control"  style="background-color:#e6e6e6" >
</div>
<div class="col-sm-6">
<label for="code" style="float: right;"><strong>ترميز المنتج</strong></label>
<input type="text" value="{{ old('code') ??  $primeryMaterial->code  }}" name="code" class="form-control"  style="background-color:#e6e6e6" >
</div>

<div class="col-sm-6" style="float: right;">
    <label for="public_name" style="float: right;"><strong>الاسم التجاري  </strong></label>
    <input type="text" value="{{  $primeryMaterial->public_name  }}" name="public_name" class="form-control" style="background-color:#e6e6e6" required>
    </div>
